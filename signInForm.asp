<% valid = Session.Contents("Valid")
pass = Session.Contents("Password")
changed = Session.Contents("Changed")
   if valid = "Not" then
    Session.Contents.Remove("Valid")
    call display
    end if
    if pass = "wrong" then
    ...
    if changed = "Yes" then
        Session.Contents.Remove("Changed")
        call success
    end if
Function display
    %>
...
Function success
    %>
         <script type ="text/javascript">
        alert("Password Changes Successfully.Login with new Password");
    </script><%
end function
%><!DOCTYPE html>
<html lang="zxx">
              ...
              <div class="section-title">
                ...
                <div class="col-lg-8">
                    <div class="contact__form">
                        <form action="Login/SignIn.asp" onsubmit ="return CheckDetails()" method="post" >
                            <div class="row">
                                <div class="col-lg-6">
                                    <label>Email:</label>
                               ...
                               <div class="col-lg-6">
                                    <a href= "Username.asp">Forgot Password ?<br><br> 
                                    </a>
                                </div>
                                  <!--  <input type="Password" placeholder="Enter your Password" id="pass" name="pass"> -->
                               </div>
                               <div class="col-lg-12">
                                    <button type="submit" class="site-btn">Login In</button><br><br><br>
                                </div>
                            </div>
                        </form>
                    </div>
