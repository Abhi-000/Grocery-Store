              ...
              <div class="section-title">
                ...
                <div class="col-lg-8">
                    <div class="contact__form">
                        <form action="Login/EnterNewPass.asp" onsubmit ="return CheckDetails()" method="post" >
                            <div class="row">
                                    <div class="col-lg-6">
                                    <label>Enter new Password:</label>
                                    <input type="password" placeholder="Enter your New Password" id="newPass" name="newPass">
                                </div>
                                <div class="col-lg-6">
