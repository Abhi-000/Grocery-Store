...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            ...
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                     ...
                     <table border="0" align ="center"width="100%" cellpadding="0" cellspacing="0" bgcolor="#e28743">
                               <tr>
                              ...
                              <div style="line-height: 26px">
                                <td align="left" style="color: #e28743; font-size: 25px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                        <!-- main section button -->

                                        <div style="line-height: 22px;">
                                            <a href="" style="color: #eeeee4; text-decoration: none;">Bag It</a>
                                        </div>
                                    </td>
                              <tr>
                    ...
                    <tr>
                        <td height="25" style="font-size: 10px; line-height: 30px;">&nbsp;</td>
                    </tr>
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center" style="color: #000000; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            class="main-header">
                            <!-- section text ======-->
    ...
    <!-- main section -->
        ...
        <tr>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="250" cellpadding="0" cellspacing="0" bgcolor="e28743"style="border:2px solid #e28743;">
                                ...
                                <tr>
                                    <td align="center" style="color: #e28743; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                        <!-- main section button -->
                                        <div style="line-height: 22px;">
                                            <a href="http://localhost/WtProject/cake/grocery/index.asp" style="color: #eeeee4;
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">abhishekEcommCake@gmail.com</a>
