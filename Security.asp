     ...
     <div class="about__text">
              <div class="section-title">
                        <span>Please Enter the Security Questions</span>
                                <div class="col-lg-12">
                                     These will help us verify your identity incase you forogt your password
                                </div>
                        </div>
               </div>
      </div>
                ...
                <div class="col-lg-8">
                    <div class="contact__form">
                        <form action="Login/SubmitSecurity.asp" onsubmit ="return CheckDetails()" method="post">
                            <% dim user
...
' dim a
  ...
  set rs=Server.CreateObject("ADODB.RecordSet")
   ...
   a = Split(rs("SecurityQuestions"),"|",-1)
    ...
    <input type="text" placeholder="Birth Place" id="ans1" name="ans1"><br><%
    Response.write(questions(1))%>
    <input type="text" id="ans2" placeholder = " Nickname" name="ans2"><br><%
    Response.write(questions(2))%>
    <input type="text" id="ans3" placeholder = "Faviurite Pet" name="ans3"><br><%
    Response.write(questions(3))%>
    <input type="text" id="ans4" placeholder = "Hobby"name="ans4"><br><%
    Response.write(questions(4))%>
     <input type="text" id="ans5" placeholder = "Grandfather's name" name="ans5"><br>
